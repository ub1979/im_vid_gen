...
//
// Qwen : Qwen/DashScope image generation provider.
//        Supports reference-edit (max 1 ref) and text-to-image via
//        the DashScope async task API with polling.
//
// done by : main git
//
// '''
...
export const qwenImageProvider: ImageProvider = {
  ...
  // =============================================================================
  // Function generates an image using DashScope -> ImageGenRequest to ImageGenResult
  // =============================================================================
  async generate(req: ImageGenRequest): Promise<ImageGenResult> {
    /*
        generate : creates an image via the DashScope async API with polling
        req variable : generation request with prompt, optional reference image, model, and API key
    */
    // ==================================
    if (!req.apiKey) {
...
// =============================================================================
// Function pauses execution for a given duration -> number to void
// =============================================================================
function sleep(ms: number): Promise<void> {
  /*
      sleep : returns a promise that resolves after ms milliseconds
      ms variable : delay duration in milliseconds
  */
